...
<html lang="en">
<head>
  <title>Koreksi Data uji Warna - SIM KNN Warna V.2025</title>
  <meta charset="utf-8">
...
<div class="container mt-3">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="Kecerahan" name="Kecerahan" type="text" class="form-control" required="required" value="<?php echo $r1['Kecerahan'];?>">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="Kejenuhan" name="Kejenuhan" type="text" class="form-control" required="required" value="<?php echo $r1['Kejenuhan'];?>">
    </div>
  </div>
  <div class="form-group row">
    <label for="K" class="col-4 col-form-label">K / Jumlah Kluster</label> 
    <div class="col-8">
      <input id="K" name="K" type="text" class="form-control" required="required" value="<?php echo $r1['K'];?>">
    </div>
  </div> 
  <div class="form-group row">
...
if (isset($_POST['submit'])) {
  ...
  $sql="UPDATE `datauji` SET `Kecerahan`='".$Kecerahan."',`Kejenuhan`='".$Kejenuhan."',`K`='".$K."' WHERE `IdData`='".$IdData."'";
