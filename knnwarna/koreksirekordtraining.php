...
<html lang="en">
<head>
  <title>Koreksi Data Training Warna - SIM KNN Warna V.2025</title>
  <meta charset="utf-8">
...
<div class="container mt-3">
  <h2>Koreksi Data Training Warna</h2>
  <?php
...
if (isset($_POST['submit'])) {
  ...
  $sql="UPDATE `datatraining` SET `Kecerahan`='".$Kecerahan."',`Kejenuhan`='".$Kejenuhan."',`Kelas`='".$Kelas."' WHERE `IdData`='".$IdData."'";
